...
SIGNAL \LED[1]~2_combout\ : std_logic;
...
\LED[0]~1\ : cycloneive_lcell_comb
-- Equation(s):
-- \LED[0]~1_combout\ = !\SW[0]~input_o\
...
\LED[1]~2\ : cycloneive_lcell_comb
-- Equation(s):
-- \LED[1]~2_combout\ = !\SW[0]~input_o\
...
-- Equation(s):
-- \LED~0_combout\ = (\KEY[1]~input_o\ & \SW[0]~input_o\)
...
-- Equation(s):
-- \LED[2]~reg0feeder_combout\ = \LED~0_combout\
